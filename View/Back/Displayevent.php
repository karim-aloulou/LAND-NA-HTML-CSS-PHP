    ...
    <table cellpadding="0" cellspacing="0" border="0">
      <thead>
        <tr>
          <th>ID event</th>
          <th>Nom event</th>
          <th><a href="Displayeventd.php" style='color:#ffffff;font-size:15px;padding:8px 12px;border-radius:3px;-moz-border-radius:3px;-webkit-border-radius:3px;text-decoration:none;'>Date</a></th>
          <th>Categorie</th>
          <th>Departement</th>
          <th>Staff</th>
          <th>Modifier</th>
  ...
  <div class="tbl-content">
    ...
    <?php
      ...
      <tr>
		...
		<td>
		 			<a href="supprimerEvent.php?Id_event=<?php echo $eventC['Id_event']; ?>"><img src="images/supprimer (1).png" alt="" width="40" height="40" ></a>
				</td>
		 	</tr>
		 	<?php
		 		}
