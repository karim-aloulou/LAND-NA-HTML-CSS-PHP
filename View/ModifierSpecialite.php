        ...
        <form action="" method="POST">
            <table border="1" align="center">
                <tr>
                    ...
                    <td><input type="text" name="ID_SPEC" id="ID_SPEC" value="<?php echo $specialite['ID_SPEC']; ?>" maxlength="20"></td>
                </tr>
				<tr>
                    <td>
                    ...
                    <td><input type="text" name="NOM_SPEC" id="NOM_SPEC" value="<?php echo $specialite['NOM_SPEC']; ?>" maxlength="20"></td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td><input type="text" name="TYPE_SPEC" id="TYPE_SPEC" value="<?php echo $specialite['TYPE_SPEC']; ?>" maxlength="20"></td>
                </tr>
